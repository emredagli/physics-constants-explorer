...
| [Nuclear magneton](https://en.wikipedia.org/wiki/Nuclear_magneton)                                                                                         | { [5.0507837461(15)E-27](https://physics.nist.gov/cgi-bin/cuu/CCValue?mub) } [ A·m² ]     | $$\mu _{\text{N}}={{e\hbar } \over {2m _{\text{p}}}}$$                                              | ℎ⋅e / (2²⋅π⋅μ⋅m_e)<br>[The output file](/research/output/derived_constants/nuclear_magneton.txt)             |
