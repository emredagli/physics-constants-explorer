...
@pytest.mark.parametrize(
    ...
    [
        ...
        # With Given error
        ("Stefan–Boltzmann constant", "5.670374(25)E-8", "kg/(s^3 K^4)",
         "2 ⋅ pi⁵ ⋅ boltzmann_constant⁴ / (3 ⋅ 5 ⋅ speed_of_light² ⋅ planck_constant³)"),
        ("Rydberg constant", "1.09737315(25)e+7", "1/m",
         "elementary_charge⁴ ⋅ electron_mass / (2³ ⋅ speed_of_light ⋅ planck_constant³ ⋅ vacuum_permittivity²)"),
        ("Vacuum permeability (magnetic constant)", "1.256637062(25)e-6", "m kg/(A^2 s^2)",
         "1 / (speed_of_light² ⋅ vacuum_permittivity)"),
        ("Fine structure constant", "7.29735256(25)E-3", "",
         "elementary_charge² / (2 ⋅ speed_of_light ⋅ planck_constant ⋅ vacuum_permittivity)")
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("vacuum_permittivity", "8.8541878127647313149341707111914842699353(35)E-12", "A^2 s^4/(kg m^3)"),
