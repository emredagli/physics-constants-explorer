...
| [Thomson Cross Section](https://en.wikipedia.org/wiki/Thomson_scattering)                                                                                  | $$\sigma _{t}={\frac {8\pi }{3}}\left({\frac {q^{2}}{4\pi \varepsilon _{0}mc^{2}}}\right)^{2}$$     | {&nbsp;[6.6524587321(60)E-29](https://physics.nist.gov/cgi-bin/cuu/Value?sigmae)&nbsp;}<br>[&nbsp;m²&nbsp;]      | (1&nbsp;/&nbsp;(2⋅3⋅π))&nbsp;⋅&nbsp;(e⁴&nbsp;/&nbsp;(m_e²⋅c⁴⋅ε_0²)) | [The&nbsp;output&nbsp;file](https://github.com/emredagli/physics-constants-explorer/blob/main/research/output/derived_constants/thomson_cross_section.txt)                    |
| ...                                                                                                                                                        |                                                                                                     |                                                                                                                  |                                                                     |                                                                                                                                                                               |
